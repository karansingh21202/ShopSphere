...
export const EditorData = () => (
  ...
  Karan Singh  
  <br></br>
  I am a skilled developer with expertise in React.js, Node.js, MongoDB, and Socket.io, demonstrated through 
  projects like **On Cart** (streamlined campus food ordering platform), **Shorty** (a dynamic social media platform), 
  and **Swayam** (real-time support platform for individuals facing depression).  
  <br></br>
  My technical skill set includes programming languages like C, C++, and Python, and web technologies like MySQL, 
  Bootstrap, and JavaScript. I am proficient with tools such as Visual Studio Code, Google Colab, and Jupyter Notebook, 
  complemented by a strong foundation in data structures, algorithms, and DBMS.  
  <br></br>
  I have actively participated in leadership roles, serving as **Joint Secretary of the Public & Relations Cell**, 
  where I successfully organized the Alumni Meet 2022-23 and led project-based learning initiatives.  
  <br></br>
  My achievements include being a **Specialist on Codeforces** (Rating: 1561) and a **Knight on LeetCode**. Beyond academics, 
  I am an avid sports enthusiast, community volunteer, and traveler, constantly exploring new places and cultures.  
</h3>
...
export const recentTransactions = [
  ...
  // Updated dummy data (15 new entries)
  {
    icon: <BsCurrencyDollar />,
    amount: "+$750",
...
export const usersData = [
  { UserID: 1, UserName: "John Doe", Email: "john.doe@example.com", Role: "Admin", Status: "Active" },
  { UserID: 2, UserName: "Jane Smith", Email: "jane.smith@example.com", Role: "Editor", Status: "Inactive" },
  { UserID: 3, UserName: "Michael Johnson", Email: "michael.johnson@example.com", Role: "Manager", Status: "Active" },
  { UserID: 4, UserName: "Emily Davis", Email: "emily.davis@example.com", Role: "Support", Status: "Active" },
  { UserID: 5, UserName: "Sarah Wilson", Email: "sarah.wilson@example.com", Role: "Admin", Status: "Inactive" },
  { UserID: 6, UserName: "James Brown", Email: "james.brown@example.com", Role: "Editor", Status: "Active" },
  { UserID: 7, UserName: "Patricia Lee", Email: "patricia.lee@example.com", Role: "Support", Status: "Active" },
  { UserID: 8, UserName: "Daniel Garcia", Email: "daniel.garcia@example.com", Role: "Editor", Status: "Inactive" },
  { UserID: 9, UserName: "Matthew Martinez", Email: "matthew.martinez@example.com", Role: "Manager", Status: "Active" },
  { UserID: 10, UserName: "Olivia Perez", Email: "olivia.perez@example.com", Role: "Support", Status: "Inactive" },
  { UserID: 11, UserName: "David Taylor", Email: "david.taylor@example.com", Role: "Editor", Status: "Active" },
  { UserID: 12, UserName: "Sophia Anderson", Email: "sophia.anderson@example.com", Role: "Admin", Status: "Active" },
  { UserID: 13, UserName: "Christopher Thomas", Email: "christopher.thomas@example.com", Role: "Manager", Status: "Inactive" },
  { UserID: 14, UserName: "Isabella Jackson", Email: "isabella.jackson@example.com", Role: "Support", Status: "Active" },
  { UserID: 15, UserName: "Benjamin White", Email: "benjamin.white@example.com", Role: "Editor", Status: "Active" },
  { UserID: 16, UserName: "Charlotte Harris", Email: "charlotte.harris@example.com", Role: "Admin", Status: "Inactive" },
];
export const rolesData = [
  { RoleID: 1, RoleName: "Admin", Permissions: "Read, Write, Delete, Manage Users" },
  { RoleID: 2, RoleName: "Editor", Permissions: "Read, Write, Edit" },
  { RoleID: 3, RoleName: "Manager", Permissions: "Read, Write, Edit, Assign Roles" },
  { RoleID: 4, RoleName: "Support", Permissions: "Read, Respond to Tickets" },
  { RoleID: 5, RoleName: "Contributor", Permissions: "Write, Edit Own Content" },
  { RoleID: 6, RoleName: "Moderator", Permissions: "Read, Delete Content, Ban Users" },
  { RoleID: 7, RoleName: "Viewer", Permissions: "Read Only" },
  { RoleID: 8, RoleName: "Editor-in-Chief", Permissions: "Read, Write, Edit, Manage Content" },
  { RoleID: 9, RoleName: "Admin Assistant", Permissions: "Read, Add Users, Assign Roles" },
  { RoleID: 10, RoleName: "Customer Service", Permissions: "Read, Respond to Support Requests" },
  { RoleID: 11, RoleName: "Guest", Permissions: "Read Only (Limited Access)" },
  { RoleID: 12, RoleName: "HR Manager", Permissions: "Read, Write, Manage Employees" },
  { RoleID: 13, RoleName: "Team Lead", Permissions: "Read, Assign Tasks, Edit Projects" },
  { RoleID: 14, RoleName: "Content Writer", Permissions: "Write, Edit Own Content" },
  { RoleID: 15, RoleName: "Product Manager", Permissions: "Read, Write, Edit, Manage Products" },
  { RoleID: 16, RoleName: "Financial Analyst", Permissions: "Read, Write, Access Reports" },
];
